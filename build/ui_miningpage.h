...
public:
    ...
    {
        MiningPage->setWindowTitle(QApplication::translate("MiningPage", "Mining", 0));
        usernameLabel->setText(QApplication::translate("MiningPage", "Username", 0));
        serverLabel->setText(QApplication::translate("MiningPage", "Server", 0));
        usernameLine->setText(QString());
        passwordLabel->setText(QApplication::translate("MiningPage", "Password", 0));
        portLabel->setText(QApplication::translate("MiningPage", "Port", 0));
        startButton->setText(QApplication::translate("MiningPage", "Start Mining", 0));
        shareCount->setText(QString());
        scantimeLabel->setText(QApplication::translate("MiningPage", "Scantime", 0));
        threadsLabel->setText(QApplication::translate("MiningPage", "Threads", 0));
        debugCheckBox->setText(QApplication::translate("MiningPage", "Debug Logging", 0));
        typeLabel->setText(QApplication::translate("MiningPage", "Type", 0));
        typeBox->clear();
        typeBox->insertItems(0, QStringList()
         << QApplication::translate("MiningPage", "Solo Mining", 0)
         << QApplication::translate("MiningPage", "Pool Mining", 0)
        );
        portLine->setText(QApplication::translate("MiningPage", "9332", 0));
