...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Argentum - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Bitcoin Core", 0));
        ...
        labelDebugLogfile->setText(QApplication::translate("RPCConsole", "Debug logfile", 0));
#ifndef QT_NO_TOOLTIP
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Argentum debug logfile from the current data directory. This can take a few seconds for large logfiles.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Argentum-Qt help message to get a list with possible Argentum command-line options.", 0));
#endif // QT_NO_TOOLTIP
